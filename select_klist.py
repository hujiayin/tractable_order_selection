...
def main():
    ...
    time_data_file = getattr(args, "time_data_file", "timing_log_select.csv")
    log_file = getattr(args, "timer_log", "exp_time_select.log")
    ...
    if trial == 1:
        records_file = getattr(args, "records_file", "select_records.csv")
